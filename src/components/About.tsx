...
const About: FC = () => {
  return (
    <section className="bg-dark-2 mt-[150px] py-6" id="about">
      ...
      <h3 className="capitalize font-black text-center text-3xl lg:mt-[20px] mt-[60px]">quotes</h3>

      <div
        className={`${contentPadding} grid grid-cols-quote-card gap-9 mt-[60px] max-w-[1600px] mx-auto`}
      >
        {quotes.map((quote) => (
          <div className="bg-dark-3 px-[12px] py-[14px] rounded-md duration-300 hover:-translate-y-1">
            <p>“{quote}”</p>
